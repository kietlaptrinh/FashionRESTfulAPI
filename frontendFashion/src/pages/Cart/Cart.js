        ...
        {cartItems?.length > 0 && (
          <>
            ...
            <table className="w-full text-xl">
              <thead className="text-sm bg-[#fff9c4] text-black uppercase">
                <tr>
                  {headers?.map((header) => {
                    return (
            ...
            <div className="flex justify-between bg-gray-50 p-8">
              <div>
                ...
                <form>
                  ...
                  />
                  <button className="w-[80px] h-[48px] bg-[#fff9c4] text-black">
                    Apply
                  </button>
                </form>
              </div>
              <div className="mr-20 pr-8">
                ...
                {isLoggedIn && (
                  <button
                    className="w-full items-center h-[48px] bg-[#fff9c4] border rounded-lg mt-2 text-black hover:bg-black hover:text-[#fff9c4]"
