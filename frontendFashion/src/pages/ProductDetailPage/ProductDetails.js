      ...
      <div className="flex flex-col md:flex-row px-10">
        ...
        <div className="w-[60%] px-10">
          ...
          <div className="flex flex-col py-2">
            <div className="flex gap-2">
              ...
              <Link
                ...
                to={"https://www.asos.com/discover/size-charts/"}
                target="_blank"
              >
                {"Size Charts ->"}
              </Link>
          ...
          <div className="flex py-4">
            ...
            >
              <div className="  flex h-[42px] rounded-lg w-[150px] px-2 items-center justify-center bg-black text-white  hover:bg-[#fff9c4] hover:text-black">
                <svg
                  width="17"
                  height="16"
                  className="mr-2 "
