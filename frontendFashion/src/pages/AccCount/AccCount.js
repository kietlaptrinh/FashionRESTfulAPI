...
const AccCount = () => {
  ...
  return (
    <div className="p-8">
      {isUserAdmin && (
        <div className="text-right flex justify-end mt-4">
          <Link
            to={"/admin"}
            className="px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-all duration-300"
          >
            Store Manager
          </Link>
        </div>
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      isActive
                        ? "bg-[#fff9c4] hover:bg-gray-400"
                        : "bg-gray-400 hover:bg-black hover:text-[#fff9c4]",
