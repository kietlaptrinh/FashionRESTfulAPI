package com.kietlaptrinh.shop_ecomerce.mapper;

import com.kietlaptrinh.shop_ecomerce.dto.ProductDto;
import com.kietlaptrinh.shop_ecomerce.dto.ProductResourceDto;
import com.kietlaptrinh.shop_ecomerce.dto.ProductVariantDto;
import com.kietlaptrinh.shop_ecomerce.entities.*;
import com.kietlaptrinh.shop_ecomerce.services.CategoryService;
...
public class ProductMapper {
    ...
    private String getProductThumbnail(List<Resources> resources) {
        return resources.stream().filter(Resources::getIsPrimary).findFirst().map(Resources::getUrl).orElse("default-url-or-placeholder"); //doi o day
    }
